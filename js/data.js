/**
 * Data Module
 * Responsible for fetching, caching, and providing access to student records.
 */
...
export function getStudents() {
    if (!cachedStudents) throw new Error('Data has not been loaded yet. Call fetchStudents() first.');
    return cachedStudents;
}
